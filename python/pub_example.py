...
#共10個欄位
#payload = '{"value":"1000","value_max":"800","value_min":"500","load_off_gap":"1","reload_delay":"0","reload_gap":"0","cycle":"15","mode":"\u5148\u5378\u5148\u5fa9\u6b78","group":"\u6a21\u7d44\u5e38\u95dc","created_at":"2017-06-15 02:37:31"}'
payload ='{"id":"4"}'
#payload ='{"id":"1","model":"PM100","address":"2","ch":"1","speed":"9600","circuit":"1","created_at":"2017-06-15 04:45:42"}'
@asyncio.coroutine
def pub(payload):
    try:
        C = MQTTClient()
